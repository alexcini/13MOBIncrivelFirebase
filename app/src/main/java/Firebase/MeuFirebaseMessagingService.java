...
import com.example.firebase.a13mobincrivelfirebase.MainActivity;
import com.example.firebase.a13mobincrivelfirebase.R;
...
public class MeuFirebaseMessagingService extends FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage){
        ...
        if (remoteMessage.getData().size()>0) {
            showNotification(remoteMessage.getData().get("descrição"),
                    remoteMessage.getData().get("Descrição"));
        }
